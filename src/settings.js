document.addEventListener('DOMContentLoaded', function() {
  ...
  // Load saved settings
  browserAPI.storage.sync.get(['apiBaseUrl', 'apiKey', 'model', 'srcLang', 'tagLang', 'firstPrompt', 'reflectionPrompt', 'secondPrompt'], function(result) {
    ...
    firstPrompt.value = result?.firstPrompt || 'You are an expert linguist, specializing in translation from {source_lang} to {target_lang},  please provide the {target_lang} translation for this text. \
Do not provide any explanations or text apart from the translation.\n \
{source_lang}: {source_text}\n \
{target_lang}: ';
    reflectionPrompt.value = result?.reflectionPrompt || 'You are an expert linguist specializing in translation from {source_lang} to {target_lang}. \
...
Output only the suggestions and nothing else.';
    secondPrompt.value = result?.secondPrompt || 'You are an expert linguist, specializing in translation editing from {source_lang} to {target_lang}. \
...
Output only the new translation and nothing else.';
  ...
  resetBtn.addEventListener('click', function() {
    ...
    firstPrompt.value = 'You are an expert linguist, specializing in translation from {source_lang} to {target_lang},  please provide the {target_lang} translation for this text. \
Do not provide any explanations or text apart from the translation.\n \
{source_lang}: {source_text}\n \
{target_lang}: ';
    reflectionPrompt.value = 'You are an expert linguist specializing in translation from {source_lang} to {target_lang}. \
You will be provided with a source text and its translation and your goal is to improve the translation. \
Your task is to carefully read a source text and a translation from {source_lang} to {target_lang}, and then give constructive criticism and helpful suggestions to improve the translation. \
The source text and initial translation, delimited by XML tags <SOURCE_TEXT></SOURCE_TEXT> and <TRANSLATION></TRANSLATION>, are as follows:\n \
<SOURCE_TEXT>\n \
...
Each suggestion should address one specific part of the translation.\
Output only the suggestions and nothing else.';
    secondPrompt.value = 'You are an expert linguist, specializing in translation editing from {source_lang} to {target_lang}. \
Your task is to carefully read, then edit, a translation from {source_lang} to {target_lang}, taking into account a list of expert suggestions and constructive criticisms. \
The source text, the initial translation, and the expert linguist suggestions are delimited by XML tags <SOURCE_TEXT></SOURCE_TEXT>, <TRANSLATION></TRANSLATION> and <EXPERT_SUGGESTIONS></EXPERT_SUGGESTIONS> \
as follows: \n \
<SOURCE_TEXT>\n \
